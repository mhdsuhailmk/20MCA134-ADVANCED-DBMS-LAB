...
INSERT INTO locations(location_id,street_address,postal_code,city,state_province,country_id) VALUES (2500,'Magdalen Centre','OX99ZB','Oxford','Oxford','UK');
...
INSERT INTO jobs(job_id,job_title,min_salary,max_salary) VALUES (12,'Public Relations',4500.00,10500.00);
...
ALTER TABLE employees ADD COLUMN commission decimal(8,2) DEFAULT NULL;
select * from employees;
...
/*Q2*/
select email,phone_number,first_name,last_name from employees;

/*Q3*/
select * from employees WHERE last_name='Fay';

/*Q4*/
select hire_date,last_name from employees WHERE last_name IN ('Grant', 'Whalen');

/*Q5*/
select first_name,last_name,job_id from employees WHERE job_id = (SELECT job_id FROM jobs WHERE job_title='Shipping Clerk');

/*Q6*/
select first_name,last_name,department_id from employees WHERE department_id = (SELECT department_id FROM dept WHERE department_id=8);
...
/*Q9*/
SELECT first_name,last_name,hire_date from employees WHERE YEAR(hire_date) BETWEEN 1995 AND 1997;
...
/*Q13*/
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES (207,'Paul','Newton','paul.newton@sqltutorial.org','825.123.8181','1994-06-07',1,8300.00,205,11);
